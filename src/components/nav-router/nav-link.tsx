...
export interface NavLinkAttrs extends DOM.HTMLAnchorElementAttributes<NavLink> {
  ['active-class']?: string
  replace?: boolean
}

@DOM.customElement('nav-link', {extends: 'a'})
export class NavLink extends HTMLAnchorElement implements NavLinkAttrs {
